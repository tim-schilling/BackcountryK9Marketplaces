...
namespace MarketplaceWebServiceOrders.Mock
{
    ...
    public  class MarketplaceWebServiceOrdersMock : MarketplaceWebServiceOrders {
        ...
        {
            return Invoke<ListOrdersByNextTokenResponse>("ListOrdersByNextTokenResponse.xml");
        }
        ...
        {
            return Invoke<ListOrderItemsByNextTokenResponse>("ListOrderItemsByNextTokenResponse.xml");
        }
        ...
        {
            return Invoke<GetOrderResponse>("GetOrderResponse.xml");
        }
        ...
        {
            return Invoke<ListOrdersResponse>("ListOrdersResponse.xml");
        }
