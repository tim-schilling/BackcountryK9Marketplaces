...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class InvoiceData
    {
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "InvoiceRequirement")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "BuyerSelectedInvoiceCategory")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "InvoiceTitle")]
        ...
        /// </summary>
        [XmlElementAttribute(ElementName = "InvoiceInformation")]
        ...
        protected internal String ToXMLFragment() {
            ...
            if (IsSetInvoiceRequirement()) {
                ...
                xml.Append(EscapeXML(this.InvoiceRequirement));
                xml.Append("</InvoiceRequirement>");
            }
            if (IsSetBuyerSelectedInvoiceCategory()) {
                xml.Append("<BuyerSelectedInvoiceCategory>");
                xml.Append(EscapeXML(this.BuyerSelectedInvoiceCategory));
                xml.Append("</BuyerSelectedInvoiceCategory>");
            }
            if (IsSetInvoiceTitle()) {
                xml.Append("<InvoiceTitle>");
                xml.Append(EscapeXML(this.InvoiceTitle));
                xml.Append("</InvoiceTitle>");
            }
            if (IsSetInvoiceInformation()) {
                xml.Append("<InvoiceInformation>");
                xml.Append(EscapeXML(this.InvoiceInformation));
                xml.Append("</InvoiceInformation>");
            }
            return xml.ToString();
        }
