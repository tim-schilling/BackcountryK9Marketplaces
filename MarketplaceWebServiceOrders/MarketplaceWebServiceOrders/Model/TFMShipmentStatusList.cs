...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class TFMShipmentStatusList
    {
        ...
        public TFMShipmentStatusList WithStatus(params String[] list)
        {
        ...
        protected internal String ToXMLFragment() {
            ...
            List<String> statusObjList  =  this.Status;
            foreach (String statusObj in statusObjList) { 
                xml.Append("<Status>");
                xml.Append(EscapeXML(statusObj));
                xml.Append("</Status>");
            }	
            return xml.ToString();
        }
