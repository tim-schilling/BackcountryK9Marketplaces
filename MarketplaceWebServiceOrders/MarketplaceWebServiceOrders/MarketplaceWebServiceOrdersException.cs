...
namespace MarketplaceWebServiceOrders
{
    ...
    public class MarketplaceWebServiceOrdersException : Exception 
    {
        ...
        public MarketplaceWebServiceOrdersException(String message, HttpStatusCode statusCode, ResponseHeaderMetadata rhm) : this (message)
        {
        ...
        public MarketplaceWebServiceOrdersException(String message, HttpStatusCode statusCode, String errorCode, String errorType, String requestId, String xml, ResponseHeaderMetadata rhm) : this (message, statusCode, rhm)
        {
